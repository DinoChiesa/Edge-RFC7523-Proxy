...
public abstract class JOSEToolBase {
  ...
  protected static final JOSEObjectType TYP_JWT = new JOSEObjectType("JWT");
  protected static final JOSEObjectType TYP_JOSE = new JOSEObjectType("JOSE");
  ...
  protected void determineAction() {
    ...
    } else toolAction = ToolAction.HELP;
  }
  ...
  public static PrivateKey decodePrivateKey(String privateKeyString, String password)
    ...
    if (isRSA(jwsAlg)) {
      ...
      if (pathToPrivateKeyFile != null) {
        ...
        RSAPrivateKey privateKey =
            (RSAPrivateKey) decodePrivateKey(fileContent, (String) this.options.get("P"));
    ...
    if (isECDSA(jwsAlg)) {
      ...
      if (pathToPrivateKeyFile != null) {
        ...
        ECPrivateKey privateKey =
            (ECPrivateKey) decodePrivateKey(fileContent, (String) this.options.get("P"));
